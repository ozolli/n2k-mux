...
"function drawArb(){const dtk=ARB.talker||'II';let h='<table class=arb><tr><th>PGN</th><th>Mode</th><th class=c>N2K</th><th class=c>Talker</th><th class=c>Phrases 0183</th><th class=c>ms</th><th class=srccol>Sources <small>(gauche = prioritaire)</small></th><th class=c>Total reçu</th><th class=c>Hz</th></tr>';\n"
