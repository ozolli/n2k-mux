...
".arb td{vertical-align:middle}.arb td.c{text-align:center}\n"
...
"function drawArb(){let h='<table class=arb><tr><th>PGN</th><th>Mode</th><th>N2K</th><th>0183</th><th>Sources <small>(gauche = prioritaire)</small></th></tr>';\n"
...
"  h+='<td class=c>'+(u.mappable?('<input type=checkbox data-act=o183 data-u='+ui+(u.o183?' checked':'')+'>'):'<small>—</small>')+'</td><td>';\n"
