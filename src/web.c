...
"function drawArb(){const dtk=ARB.talker||'II';let h='<table class=arb><tr><th>PGN</th><th>Mode</th><th class=c>N2K</th><th class=c>0183</th><th class=c>0183 ms</th><th class=c>Talker</th><th>Sources <small>(gauche = prioritaire)</small></th></tr>';\n"
...
"  h+='<td class=c>'+(u.hasRate?('<input class=ri style=\"width:3.2em;text-align:center\" maxlength=2 data-act=tk data-u='+ui+' value=\"'+esc(u.tk||'')+'\" placeholder=\"'+esc(dtk)+'\">'):'<small>—</small>')+'</td><td>';\n"
